...
namespace Lumina\ApiV2\Blocks\Testimonials;
...
class Transformer
{
    public static function transform(array $block): array
    {
        ...
        // The block's name is "be-impactful" but we want to return "testimonials" as the type in the API response
        return BlockResponse::make('be-impactful', [
            ...
            'list_of_clients' => array_values($clients),
        ]);
    }
}